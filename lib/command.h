...
#define LINK_STR "Link setting\n"
#define MONITOR_STR "Monitor links\n"
#define ACTOR_STR "Actor links\n"
#define DELAY_UP_STR "Delay seconds before bring up links\n"

#define FLAPPING_STR "Link flapping\n"
#define PERIOD_STR "How long to detect flapping rate.\n"
#define FLAPPING_NUMBER_STR "Flapping times in the period.\n"
#define RECOVERY_STR "Delay time(seconds) before bring up error ports.\n"


#define INTERFACE_NAME_RANGE_STR "Interface name or index or a range(e.g. 1,5-10)\n"
#define INTERFACE_RANGE_STR "Interface range, (e.g. 1,5-10)\n"
#define INTERFACE_VLAN_STR "Enter into interface vlan mode\n"
#define INTERFACE_PORT_CHANNEL_STR "Enter into port-channel vlan mode\n"
